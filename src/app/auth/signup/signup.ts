      ...
      <div class="max-w-md w-full">
        ...
        <form (submit)="onSubmit()" class="space-y-5">
          ...
          <button 
            type="submit" 
            [disabled]="isLoading()"
            class="w-full py-4 bg-[#22D3EE] text-[#020617] font-bold rounded-xl hover:bg-[#22D3EE]/90 transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-4 shadow-lg shadow-[#22D3EE]/20"
          >
        ...
        <div class="mt-6">
          <div class="relative flex items-center justify-center mb-6">
            ...
            <span class="px-4 text-xs text-gray-500 uppercase tracking-widest bg-[#020617]">Or sign up with</span>
            <div class="flex-grow border-t border-white/10"></div>
          </div>
        ...
        <div class="mt-8 text-center text-gray-400 text-sm">
          ...
          <a routerLink="/login" class="text-[#22D3EE] hover:underline font-medium">Login</a>
        </div>
...
export class SignupComponent {
  ...
  async signUpWithGoogle() {
    ...
    try {
      ...
      this.successMessage.set('Successfully signed up with Google!');
      setTimeout(() => {
        this.router.navigate(['/dashboard']);
      }, 1500);
    } catch (error: unknown) {
  ...
  private getFriendlyErrorMessage(code: string): string {
    switch (code) {
      ...
      case 'auth/popup-blocked':
        return 'Signup popup was blocked by your browser. Please allow popups for this site.';
      default:
